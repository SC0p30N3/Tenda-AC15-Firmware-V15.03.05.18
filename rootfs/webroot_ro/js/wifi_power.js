...
function changeImg(imgID, powerValue) {
    ...
    if (powerValue == "low") {
        $imgDom.attr("src", "../img/icon-power-gray1.png?ddf99c235f9eb897c1c37f8e2199b7d2");
    } else if (powerValue == "middle") {
        $imgDom.attr("src", "../img/icon-power-gray2.png?ddf99c235f9eb897c1c37f8e2199b7d2");
    } else {
        $imgDom.attr("src", "../img/icon-power.png?ddf99c235f9eb897c1c37f8e2199b7d2");
    }
}
