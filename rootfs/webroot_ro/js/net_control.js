...
function hideEditNameArea(rowEle, devName) {
	$(rowEle).find(".dev-name").text(devName).attr("title", devName).append('<img class="edit-btn edit-btn-txt-append" src="img/edit_new.png?ddf99c235f9eb897c1c37f8e2199b7d2" style="width:14px;height:14px;"/>');
}
...
function addRow(obj) {
	...
	str += "<td class='edit-td'><div class='device-icon'><img src='" + deviceType.src + "'>" + showDeviceLogoString(deviceType, obj.devType) + "</div><div class='online-device-content'><div class='dev-name text-fixed' style='padding-right: 30px;'><span class='dev-name-txt'></span><img class='edit-btn edit-btn-txt-append' src='img/edit_new.png?ddf99c235f9eb897c1c37f8e2199b7d2' style='width:14px;height:14px;' /></div><div class='txt-help-tips'>" + (obj.ip || "---") + "</div></div></td>";
