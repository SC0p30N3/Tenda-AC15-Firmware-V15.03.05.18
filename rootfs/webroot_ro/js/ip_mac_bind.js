...
function hideEditNameArea(rowEle, devName) {
    $(rowEle).find(".dev-name").text(devName).append('<img class="edit-btn none edit-btn-txt-append" src="img/edit.png?ddf99c235f9eb897c1c37f8e2199b7d2" />');
}
...
function addList() {
    ...
    str += "<tr>";
    str += "<td class='dev-name fixed edit-td' title='" + "'><span class='dev-name-txt dev-target'>" + "</span><img class='edit-btn none edit-btn-txt-append' src='img/edit.png?ddf99c235f9eb897c1c37f8e2199b7d2' /></td>";
