...
function getMoreFolder(folderId, subData) {
    ...
    if ($("#" + folderId).html() !== "") {
        ...
        //显示搜索图标
        $(".folder-scan").css("background", "url(/img/scan.gif?ddf99c235f9eb897c1c37f8e2199b7d2) 0 no-repeat");
